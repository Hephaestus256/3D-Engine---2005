...
//  set_vesa_mode(TRUE_COLOR_800x600);
  ...
  __b = scrn_buff = create_scrn_buff();
  init_view (&view, scrn_buff, deg_to_rad(65), deg_to_rad(65) / 1.5);
...
//    _spec[0].abs = offset_point_3d (cursor.pos, 0, -1, 0);
//    _spec[1].abs = offset_point_3d (cursor.pos, 0, cyl.height - 1, 0);
