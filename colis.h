...
void show_colis_step (point_3d curr, point_3d tent, point_3d closer);
...
inline bool path_int_plane_xy (tri_group group, cylinder_3d cyl,
  point_3d* result_a, point_3d* result_b, bool* pen,
  point_3d curr_top, point_3d curr_bot,
  point_3d tent_top, point_3d tent_bot);
inline bool path_int_plane_xyz (tri_group group, cylinder_3d cyl,
  point_3d* int_a, point_3d* int_b, bool* pen,
  point_3d curr_top, point_3d curr_bot,
  point_3d tent_top, point_3d tent_bot, double offset);
...
inline point_3d path_pen_xyz
  (plane_type plane, point_3d pa, point_3d pb, double offset);
inline bool colis_xz_element_up_inc (point_3d* result, point_3d* closest,
  point_3d pa, point_3d pb, point_3d b, point_3d l, point_3d r);
inline bool colis_xz_element_dn_inc (point_3d* result, point_3d* closest,
  point_3d pa, point_3d pb, point_3d b, point_3d l, point_3d r);
inline bool colis_xz_element_up_exc (point_3d* result, point_3d* closest,
  point_3d pa, point_3d pb, point_3d b, point_3d l, point_3d r);
inline bool colis_xz_element_dn_exc (point_3d* result, point_3d* closest,
  point_3d pa, point_3d pb, point_3d b, point_3d l, point_3d r);

inline bool colis_xz_tri_up_inc (point_3d* result, point_3d* closest,
  double offset, point_3d pa, point_3d pb, point_3d t, point_3d l, point_3d r);
inline bool colis_xz_tri_dn_inc (point_3d* result, point_3d* closest,
  double offset, point_3d pa, point_3d pb, point_3d b, point_3d l, point_3d r);
inline bool colis_xz_tri_up_exc (point_3d* result, point_3d* closest,
  double offset, point_3d pa, point_3d pb, point_3d t, point_3d l, point_3d r);
inline bool colis_xz_tri_dn_exc (point_3d* result, point_3d* closest,
  double offset, point_3d pa, point_3d pb, point_3d b, point_3d l, point_3d r);

inline point_3d int_edge_and_z (point_3d mid, point_3d p1, point_3d p2);
inline bool colis_xz_plane_inc
  (point_3d* result, point_3d* closest, double offset,
  point_3d pa, point_3d pb, point_3d p1, point_3d p2, point_3d p3);
inline bool colis_xz_plane_exc
  (point_3d* result, point_3d* closest, double offset,
  point_3d pa, point_3d pb, point_3d p1, point_3d p2, point_3d p3);
...
inline bool colis_yz_tri_up (bool* slide, plane_type* res_plane, point_3d* result, point_3d* closest, tri_group group, double offset,
  point_3d pa, point_3d pb, bool pen, point_3d t, point_3d l, point_3d r,
  point_3d curr_top, point_3d curr_bot,
  point_3d tent_top, point_3d tent_bot);
...
inline bool colis_yz_tri
  (bool* slide, plane_type* res_plane, point_3d* result, point_3d* closest, tri_group group, double offset,
   point_3d pa, point_3d pb, bool pen, point_3d p1, point_3d p2, point_3d p3,
   point_3d curr_top, point_3d curr_bot,
   point_3d tent_top, point_3d tent_bot);
...
inline bool colis_yz_element_up (bool* slide, plane_type* res_plane, point_3d* result, plane_type plane,
  double offset, point_3d pa, point_3d pb, bool pen, point_3d t, point_3d l, point_3d r);
inline bool colis_yz_element_dn (bool* slide, plane_type* res_plane, point_3d* result, plane_type plane,
  double offset, point_3d pa, point_3d pb, bool pen, point_3d b, point_3d l, point_3d r);
inline bool path_int_xz_horz
  (point_3d pa, point_3d pb,
  point_3d l, point_3d r, point_3d* result);
inline bool path_int_yz_horz
  (point_3d pa, point_3d pb, bool pen, plane_type plane, double offset,
...
inline bool colis_xy_tri_up
  (bool* slide, plane_type* res_plane, point_3d* result, point_3d* closest, tri_group group, double offset,
   point_3d pa, point_3d pb, bool pen, point_3d b, point_3d l, point_3d r,
   point_3d curr_top, point_3d curr_bot,
   point_3d tent_top, point_3d tent_bot);
...
void show_junk (point_3d closer, point_3d curr, point_3d tent);
plane_type calc_y_plane (double y);
double calc_fall_angle (plane_type plane);
  ...
  point_3d tent_top, point_3d tent_bot)
{
  ...
  if (group.vis_side == -1) {
    if (approx_equal (tent_top.x, group.plane.b - cyl.radius))
      return false;
    else
  ...
  (plane_type plane, point_3d pa, point_3d pb, double offset)
{
  ...
  if (approx_equal (pa.z, pb.z))
    if (approx_equal (pa.x, pb.x)) {
      p.x = pa.x;
      p.y = (pa.z - (plane.b + offset) - plane.m1 * pa.x) / plane.m2;
      p.z = pa.z;
    }
    else {
...
//  double offset = group.plane.sec_m1 * cyl.radius;
  ...
  if (group.vis_side == -1) {
    if (approx_lesser_inc (curr_top.z, group.plane.m1 * curr_top.x + group.plane.m2 * curr_top.y + group.plane.b - offset))
      if (approx_lesser_inc (curr_bot.z, group.plane.m1 * curr_bot.x + group.plane.m2 * curr_bot.y + group.plane.b - offset))
        if (approx_lesser_inc (tent_top.z, group.plane.m1 * tent_top.x + group.plane.m2 * tent_top.y + group.plane.b - offset))
          if (approx_lesser_inc (tent_bot.z, group.plane.m1 * tent_bot.x + group.plane.m2 * tent_bot.y + group.plane.b - offset)) // 1
            return false;
          else { // 2
          ...
          if (approx_lesser_inc (tent_bot.z, group.plane.m1 * tent_bot.x + group.plane.m2 * tent_bot.y + group.plane.b - offset)) { // 3
        ...
        if (approx_lesser_inc (tent_top.z, group.plane.m1 * tent_top.x + group.plane.m2 * tent_top.y + group.plane.b - offset))
          if (approx_lesser_inc (tent_bot.z, group.plane.m1 * tent_bot.x + group.plane.m2 * tent_bot.y + group.plane.b - offset)) { // 5
            bprint ("5", 7);
//            return false;
          ...
          if (approx_lesser_inc (tent_bot.z, group.plane.m1 * tent_bot.x + group.plane.m2 * tent_bot.y + group.plane.b - offset)) // 7
            return false; // N/A
          else { // 8
//            return false;
            bprint ("8", 7);
      ...
      if (approx_lesser_inc (curr_bot.z, group.plane.m1 * curr_bot.x + group.plane.m2 * curr_bot.y + group.plane.b - offset))
        if (approx_lesser_inc (tent_top.z, group.plane.m1 * tent_top.x + group.plane.m2 * tent_top.y + group.plane.b - offset))
          if (approx_lesser_inc (tent_bot.z, group.plane.m1 * tent_bot.x + group.plane.m2 * tent_bot.y + group.plane.b - offset)) { // 9
            bprint ("9", 7);
//            return false;
            *int_a = line_pen_xyz (group.plane, curr_top, -offset);
            *int_b = path_pen_xyz (group.plane, curr_top, tent_top, -offset);
          ...
          if (approx_lesser_inc (tent_bot.z, group.plane.m1 * tent_bot.x + group.plane.m2 * tent_bot.y + group.plane.b - offset)) { // 11
            bprint ("11", 7);
            *int_a = line_pen_xyz (group.plane, curr_top, -offset);
            *int_b = line_pen_xyz (group.plane, tent_top, -offset);
            *pen = true;            
        ...
        if (approx_lesser_inc (tent_top.z, group.plane.m1 * tent_top.x + group.plane.m2 * tent_top.y + group.plane.b - offset))
          if (approx_lesser_inc (tent_bot.z, group.plane.m1 * tent_bot.x + group.plane.m2 * tent_bot.y + group.plane.b - offset)) { // 13
            bprint ("13", 7);
//            return false;
            *int_a = path_pen_xyz (group.plane, curr_top, tent_top, -offset);
            *int_b = path_pen_xyz (group.plane, curr_bot, tent_bot, -offset);
...
//            return false;
          ...
          if (approx_lesser_inc (tent_bot.z, group.plane.m1 * tent_bot.x + group.plane.m2 * tent_bot.y + group.plane.b - offset)) { // 15
            bprint ("15", 7);
//            return false;
            *int_a = path_pen_xyz (group.plane, curr_bot, tent_bot, -offset);
            *int_b = line_pen_xyz (group.plane, tent_top, -offset);
    ...
    if (approx_greater_inc (curr_top.z, group.plane.m1 * curr_top.x + group.plane.m2 * curr_top.y + group.plane.b + offset))
      if (approx_greater_inc (curr_bot.z, group.plane.m1 * curr_bot.x + group.plane.m2 * curr_bot.y + group.plane.b + offset))
        if (approx_greater_inc (tent_top.z, group.plane.m1 * tent_top.x + group.plane.m2 * tent_top.y + group.plane.b + offset))
          if (approx_greater_inc (tent_bot.z, group.plane.m1 * tent_bot.x + group.plane.m2 * tent_bot.y + group.plane.b + offset)) // 1
            return false;
          else { // 2
            *int_a = path_pen_xyz (group.plane, curr_bot, tent_bot, offset);
            *int_b = line_pen_xyz (group.plane, tent_top, offset);
          ...
          if (approx_greater_inc (tent_bot.z, group.plane.m1 * tent_bot.x + group.plane.m2 * tent_bot.y + group.plane.b + offset)) { // 3
            *int_a = path_pen_xyz (group.plane, curr_top, tent_top, offset);
            *int_b = line_pen_xyz (group.plane, tent_top, offset);
            *pen = false;
            bprint ("3", 7);
        ...
        if (approx_greater_inc (tent_top.z, group.plane.m1 * tent_top.x + group.plane.m2 * tent_top.y + group.plane.b + offset))
          if (approx_greater_inc (tent_bot.z, group.plane.m1 * tent_bot.x + group.plane.m2 * tent_bot.y + group.plane.b + offset)) { // 5
            return false;
...
//            *int_b = path_pen_xyz (group.plane, curr_bot, tent_bot);
          ...
          if (approx_greater_inc (tent_bot.z, group.plane.m1 * tent_bot.x + group.plane.m2 * tent_bot.y + group.plane.b + offset)) // 7
            return false; // N/A
          else { // 8
            bprint ("8", 7);
            *int_a = line_pen_xyz (group.plane, curr_top, offset);
      ...
      if (approx_greater_inc (curr_bot.z, group.plane.m1 * curr_bot.x + group.plane.m2 * curr_bot.y + group.plane.b + offset))
        if (approx_greater_inc (tent_top.z, group.plane.m1 * tent_top.x + group.plane.m2 * tent_top.y + group.plane.b + offset))
          if (approx_greater_inc (tent_bot.z, group.plane.m1 * tent_bot.x + group.plane.m2 * tent_bot.y + group.plane.b + offset)) { // 9
            return false;
//            *int_a = line_pen_xyz (group.plane, curr_top);
//            *int_b = path_pen_xyz (group.plane, curr_top, tent_top);
          ...
          if (approx_greater_inc (tent_bot.z, group.plane.m1 * tent_bot.x + group.plane.m2 * tent_bot.y + group.plane.b + offset)) { // 11
            bprint ("11", 7);
            *int_a = line_pen_xyz (group.plane, curr_top, offset);
            *int_b = line_pen_xyz (group.plane, tent_top, offset);
            *pen = true;            
        ...
        if (approx_greater_inc (tent_top.z, group.plane.m1 * tent_top.x + group.plane.m2 * tent_top.y + group.plane.b + offset))
          if (approx_greater_inc (tent_bot.z, group.plane.m1 * tent_bot.x + group.plane.m2 * tent_bot.y + group.plane.b + offset)) { // 13
            return false;
...
//            *int_b = line_pen_xyz (group.plane, tent_top);
          ...
          if (approx_greater_inc (tent_bot.z, group.plane.m1 * tent_bot.x + group.plane.m2 * tent_bot.y + group.plane.b + offset)) { // 15
            return false;
   ...
   point_3d tent_top, point_3d tent_bot)
{
  ...
  if (path_int_plane_xy (group, cyl, &result_a, &result_b, &pen, curr_top, curr_bot, tent_top, tent_bot)) {
    closer = result_b;
    for (tri_type* tri = group.first; tri != NULL; tri = tri->next)
      if (colis_yz_tri (slide, &plane, result, &closer, group, cyl.radius, result_a, result_b, pen, tri->t3d.p1->abs, tri->t3d.p2->abs, tri->t3d.p3->abs, curr_top, curr_bot, tent_top, tent_bot))
        colis = true;
  }
   ...
   point_3d tent_top, point_3d tent_bot)
{
  ...
  if (path_int_plane_xy (group, cyl, &result_a, &result_b, &pen, curr_top, curr_bot, tent_top, tent_bot)) {
    closer = result_b;
    for (tri_type* tri = group.first; tri != NULL; tri = tri->next)
      if (colis_yz_tri (slide, &plane, result, &closer, group, -cyl.radius, result_a, result_b, pen, tri->t3d.p3->abs, tri->t3d.p2->abs, tri->t3d.p1->abs, curr_top, curr_bot, tent_top, tent_bot))
        colis = true;
  }
   ...
   point_3d tent_top, point_3d tent_bot)
{
  ...
  if (path_int_plane_x (group, cyl, &result_a, curr_top, curr_bot, tent_top, tent_bot)) {
    ...
    closer = result_b;
    for (tri_type* tri = group.first; tri != NULL; tri = tri->next)
      if (colis_yz_tri (slide, &plane, result, &closer, group, cyl.radius, result_a, result_b, false, tri->t3d.p1->abs, tri->t3d.p2->abs, tri->t3d.p3->abs, curr_top, curr_bot, tent_top, tent_bot))
        colis = true;
  }
   ...
   point_3d tent_top, point_3d tent_bot)
{
  ...
  if (path_int_plane_x (group, cyl, &result_a, curr_top, curr_bot, tent_top, tent_bot)) {
    ...
    closer = result_b;    
    for (tri_type* tri = group.first; tri != NULL; tri = tri->next)
      if (colis_yz_tri (slide, &plane, result, &closer, group, -cyl.radius, result_a, result_b, false, tri->t3d.p3->abs, tri->t3d.p2->abs, tri->t3d.p1->abs, curr_top, curr_bot, tent_top, tent_bot))
        colis = true;
  }
...
{
  for (tri_type* tri = group.first; tri != NULL; tri = tri->next)
    if (colis_xz_plane_inc (result, closest, offset, pa, pb,
    tri->t3d.p1->abs, tri->t3d.p2->abs, tri->t3d.p3->abs))
      return true;
   ...
   point_3d tent_top, point_3d tent_bot)
{
  ...
  if (approx_lesser (p1.y, p2.y))
    if (approx_lesser (p3.y, p1.y)) { // 3,1,2
      ...
      if (colis_yz_tri_up (slide, res_plane, result, closest, group, offset, pa, pb, pen, p3, mid, p1, curr_top, curr_bot, tent_top, tent_bot))
        colis = true;
      if (colis_yz_tri_dn (slide, res_plane, result, closest, group, offset, pa, pb, pen, p2, mid, p1, curr_top, curr_bot, tent_top, tent_bot))
        colis = true;
    }
    else if (approx_greater (p3.y, p2.y)) { // 1,2,3
      point_3d mid = int_yz_edge_and_y (p1, p2, p3);
      if (colis_yz_tri_up (slide, res_plane, result, closest, group, offset, pa, pb, pen, p1, mid, p2, curr_top, curr_bot, tent_top, tent_bot))
        colis = true;
      if (colis_yz_tri_dn (slide, res_plane, result, closest, group, offset, pa, pb, pen, p3, mid, p2, curr_top, curr_bot, tent_top, tent_bot))
        colis = true;
    }
    else if (approx_equal (p3.y, p1.y)) // 1-3,2
      return colis_yz_tri_dn (slide, res_plane, result, closest, group, offset, pa, pb, pen, p2, p3, p1, curr_top, curr_bot, tent_top, tent_bot);
    else if (approx_equal (p3.y, p2.y)) // 1,2-3
      return colis_yz_tri_up (slide, res_plane, result, closest, group, offset, pa, pb, pen, p1, p3, p2, curr_top, curr_bot, tent_top, tent_bot);
    else { // 1,3,2
      point_3d mid = int_yz_edge_and_y (p1, p3, p2);
      if (colis_yz_tri_up (slide, res_plane, result, closest, group, offset, pa, pb, pen, p1, p3, mid, curr_top, curr_bot, tent_top, tent_bot))
        colis = true;
      if (colis_yz_tri_dn (slide, res_plane, result, closest, group, offset, pa, pb, pen, p2, p3, mid, curr_top, curr_bot, tent_top, tent_bot))
        colis = true;
    }
  else if (approx_greater (p1.y, p2.y))
    if (approx_lesser (p3.y, p2.y)) { // 3,2,1
      point_3d mid = int_yz_edge_and_y (p3, p2, p1);
      if (colis_yz_tri_up (slide, res_plane, result, closest, group, offset, pa, pb, pen, p3, p2, mid, curr_top, curr_bot, tent_top, tent_bot))
        colis = true;
      if (colis_yz_tri_dn (slide, res_plane, result, closest, group, offset, pa, pb, pen, p1, p2, mid, curr_top, curr_bot, tent_top, tent_bot))
        colis = true;
    }
    else if (approx_greater (p3.y, p1.y)) { // 2,1,3
      point_3d mid = int_yz_edge_and_y (p2, p1, p3);
      if (colis_yz_tri_up (slide, res_plane, result, closest, group, offset, pa, pb, pen, p2, p1, mid, curr_top, curr_bot, tent_top, tent_bot))
        colis = true;
      if (colis_yz_tri_dn (slide, res_plane, result, closest, group, offset, pa, pb, pen, p3, p1, mid, curr_top, curr_bot, tent_top, tent_bot))
        colis = true;
    }
    else if (approx_equal (p3.y, p2.y)) // 2-3,1
      return colis_yz_tri_dn (slide, res_plane, result, closest, group, offset, pa, pb, pen, p1, p2, p3, curr_top, curr_bot, tent_top, tent_bot);
    else if (approx_equal (p3.y, p1.y)) // 2,1-3
      return colis_yz_tri_up (slide, res_plane, result, closest, group, offset, pa, pb, pen, p2, p1, p3, curr_top, curr_bot, tent_top, tent_bot);
    else { // 2,3,1
      point_3d mid = int_yz_edge_and_y (p2, p3, p1);
      if (colis_yz_tri_up (slide, res_plane, result, closest, group, offset, pa, pb, pen, p2, mid, p3, curr_top, curr_bot, tent_top, tent_bot))
        colis = true;
      if (colis_yz_tri_dn (slide, res_plane, result, closest, group, offset, pa, pb, pen, p1, mid, p3, curr_top, curr_bot, tent_top, tent_bot))
        colis = true;
    }
  else
    if (approx_lesser (p3.y, p1.y)) // 3,1-2
      return colis_yz_tri_up (slide, res_plane, result, closest, group, offset, pa, pb, pen, p3, p2, p1, curr_top, curr_bot, tent_top, tent_bot);
    else if (approx_greater (p3.y, p1.y)) // 1-2,3
      return colis_yz_tri_dn (slide, res_plane, result, closest, group, offset, pa, pb, pen, p3, p1, p2, curr_top, curr_bot, tent_top, tent_bot);
    else // 1-2-3
      return false;
...
{
  point_3d result;
  y_line_3d edge = calc_y_line_3d (p1, p2);
  
  result.x = edge.mx * mid.y + edge.bx;
  result.y = mid.y;
  result.z = edge.mz * mid.y + edge.bz;
   ...
   point_3d tent_top, point_3d tent_bot)
{
  ...
  if (colis_yz_element_up (slide, &plane, result, group.plane, offset, pa, pb, pen, tl, bl, br)) {
    store_closer (closest, *result, pa, plane, slide, res_plane);
    colis = true;    
  }
  if (colis_yz_element_dn (slide, &plane, result, group.plane, offset, pa, pb, pen, br, tl, tr)) {
    store_closer (closest, *result, pa, plane, slide, res_plane);
    colis = true;
  }
  ...
  double offset, point_3d pa, point_3d pb, bool pen, point_3d t, point_3d l, point_3d r)
{
  ...
  if (pen) {
    if (approx_greater_inc (pa.y, l.y)) { // -inc
      a_in = false;
      if (approx_greater (pb.y, l.y))
        return false;
      else
        if (path_int_yz_horz (pa, pb, pen, plane, offset, l, r, slide, res_plane, result))
          return true;
    }
    ...
    if (approx_greater (pa.y, l.y)) { // -inc
      a_in = false;
      if (approx_greater (pb.y, l.y))
        return false;
      else
    ...
    lin_relat le = calc_dzdy_line (t, l);
    if (approx_lesser (pa.z, le.m * pa.y + le.b)) {
      a_in = false;
      if (approx_lesser (pb.z, le.m * pb.y + le.b))
        return false;
      else
    ...
    lin_relat re = calc_dzdy_line (t, r);
    if (approx_greater (pa.z, re.m * pa.y + re.b)) {
      a_in = false;
      if (approx_greater (pb.z, re.m * pb.y + re.b))
        return false;
      else
  ...
  double offset, point_3d pa, point_3d pb, bool pen, point_3d b, point_3d l, point_3d r)
{
  ...
  if (approx_lesser_inc (pa.y, l.y)) { // -inc
    a_in = false;
  ...
  if (approx_lesser_inc (pa.z, le.m * pa.y + le.b)) { // -inc
    a_in = false;  
    if (approx_lesser (pb.z, le.m * pb.y + le.b))
      return false;
    else
  ...
  if (approx_greater_inc (pa.z, re.m * pa.y + re.b)) { // -inc
    a_in = false;  
    if (approx_greater (pb.z, re.m * pb.y + re.b))
      return false;
    else
  ...
  point_3d l, point_3d r, bool* slide, plane_type* res_plane, point_3d* result)
{
  if (approx_equal (pa.y, pb.y)) {
    if (!pen)
      if (approx_greater_inc (pa.x, l.x))
        if (approx_lesser_inc (pa.x, r.x)) {
          *result = pa;
          *res_plane = plane;        
          return true;
        }
  ...
  if (approx_greater_inc (int_z, l.z)) // - inc
    if (approx_lesser_inc (int_z, r.z)) {  // - inc
      result->y = l.y;
      result->z = int_z;
   ...
   point_3d p1, point_3d p2, bool* slide, plane_type* res_plane, point_3d* result)
{
  ...
  if (approx_equal (pa.y, pb.y))
    ...
    if (approx_equal (edge.m, path.m))
      return false;
    else
      result->y = (path.b - edge.b) / (edge.m - path.m);
  }
    
  if (approx_greater_inc (result->y, p1.y)) // - inc
    if (approx_lesser_inc (result->y, p2.y)) { // - inc
  ...
  point_3d pa, point_3d pb, point_3d p1, point_3d p2, point_3d p3)
{
  if (approx_greater (p1.z, p2.z))
    if (approx_greater (p3.z, p1.z)) { // 3,1,2
      ...
      if (colis_xz_element_up_inc (result, closest, pa, pb, p3, mid, p1))
        return true;
      if (colis_xz_element_dn_inc (result, closest, pa, pb, p2, mid, p1))
        return true;
    }
    else if (approx_lesser (p3.z, p2.z)) { // 1,2,3
      point_3d mid = int_edge_and_z (p1, p2, p3);
      if (colis_xz_element_up_inc (result, closest, pa, pb, p1, mid, p2))
        return true;
      if (colis_xz_element_dn_inc (result, closest, pa, pb, p3, mid, p2))
        return true;
    }
    else if (approx_equal (p3.z, p1.z)) // 1-3,2
      return colis_xz_element_dn_inc (result, closest, pa, pb, p2, p3, p1);
    else if (approx_equal (p3.z, p2.z)) // 1,2-3
      return colis_xz_element_up_inc (result, closest, pa, pb, p1, p3, p2);
    else { // 1,3,2
      point_3d mid = int_edge_and_z (p1, p3, p2);
      if (colis_xz_element_up_inc (result, closest, pa, pb, p1, p3, mid))
        return true;
      if (colis_xz_element_dn_inc (result, closest, pa, pb, p2, p3, mid))
        return true;
    }
  else if (approx_lesser (p1.z, p2.z))
    if (approx_greater (p3.z, p2.z)) { // 3,2,1
      point_3d mid = int_edge_and_z (p3, p2, p1);
      if (colis_xz_element_up_inc (result, closest, pa, pb, p3, p2, mid))
        return true;
      if (colis_xz_element_dn_inc (result, closest, pa, pb, p1, p2, mid))
        return true;
    }
    else if (approx_lesser (p3.z, p1.z)) { // 2,1,3
      point_3d mid = int_edge_and_z (p2, p1, p3);
      if (colis_xz_element_up_inc (result, closest, pa, pb, p2, p1, mid))
        return true;
      if (colis_xz_element_dn_inc (result, closest, pa, pb, p3, p1, mid))
        return true;
    }
    else if (approx_equal (p3.z, p2.z)) // 2-3,1
      return colis_xz_element_dn_inc (result, closest, pa, pb, p1, p2, p3);
    else if (approx_equal (p3.z, p1.z)) // 2,1-3
      return colis_xz_element_up_inc (result, closest, pa, pb, p2, p1, p3);
    else { // 2,3,1
      point_3d mid = int_edge_and_z (p2, p3, p1);
      if (colis_xz_element_up_inc (result, closest, pa, pb, p2, mid, p3))
        return true;
      if (colis_xz_element_dn_inc (result, closest, pa, pb, p1, mid, p3))
        return true;
    }
  else
    if (approx_greater (p3.z, p1.z)) // 3,1-2
      return colis_xz_element_up_inc (result, closest, pa, pb, p3, p2, p1);
    else if (approx_lesser (p3.z, p1.z)) // 1-2,3
      return colis_xz_element_dn_inc (result, closest, pa, pb, p3, p1, p2);
    else // 1-2-3
      return false;
  ...
  point_3d pa, point_3d pb, point_3d p1, point_3d p2, point_3d p3)
{
  if (approx_greater (p1.z, p2.z))
    if (approx_greater (p3.z, p1.z)) { // 3,1,2
      point_3d mid = int_edge_and_z (p3, p1, p2);
      if (colis_xz_element_up_exc (result, closest, pa, pb, p3, mid, p1))
        return true;
      if (colis_xz_element_dn_exc (result, closest, pa, pb, p2, mid, p1))
        return true;
    }
    else if (approx_lesser (p3.z, p2.z)) { // 1,2,3
      point_3d mid = int_edge_and_z (p1, p2, p3);
      if (colis_xz_element_up_exc (result, closest, pa, pb, p1, mid, p2))
        return true;
      if (colis_xz_element_dn_exc (result, closest, pa, pb, p3, mid, p2))
        return true;
    }
    else if (approx_equal (p3.z, p1.z)) // 1-3,2
      return colis_xz_element_dn_exc (result, closest, pa, pb, p2, p3, p1);
    else if (approx_equal (p3.z, p2.z)) // 1,2-3
      return colis_xz_element_up_exc (result, closest, pa, pb, p1, p3, p2);
    else { // 1,3,2
      point_3d mid = int_edge_and_z (p1, p3, p2);
      if (colis_xz_element_up_exc (result, closest, pa, pb, p1, p3, mid))
        return true;
      if (colis_xz_element_dn_exc (result, closest, pa, pb, p2, p3, mid))
        return true;
    }
  else if (approx_lesser (p1.z, p2.z))
    if (approx_greater (p3.z, p2.z)) { // 3,2,1
      point_3d mid = int_edge_and_z (p3, p2, p1);
      if (colis_xz_element_up_exc (result, closest, pa, pb, p3, p2, mid))
        return true;
      if (colis_xz_element_dn_exc (result, closest, pa, pb, p1, p2, mid))
        return true;
    }
    else if (approx_lesser (p3.z, p1.z)) { // 2,1,3
      point_3d mid = int_edge_and_z (p2, p1, p3);
      if (colis_xz_element_up_exc (result, closest, pa, pb, p2, p1, mid))
        return true;
      if (colis_xz_element_dn_exc (result, closest, pa, pb, p3, p1, mid))
        return true;
    }
    else if (approx_equal (p3.z, p2.z)) // 2-3,1
      return colis_xz_element_dn_exc (result, closest, pa, pb, p1, p2, p3);
    else if (approx_equal (p3.z, p1.z)) // 2,1-3
      return colis_xz_element_up_exc (result, closest, pa, pb, p2, p1, p3);
    else { // 2,3,1
      point_3d mid = int_edge_and_z (p2, p3, p1);
      if (colis_xz_element_up_exc (result, closest, pa, pb, p2, mid, p3))
        return true;
      if (colis_xz_element_dn_exc (result, closest, pa, pb, p1, mid, p3))
        return true;
    }
  else
    if (approx_greater (p3.z, p1.z)) // 3,1-2
      return colis_xz_element_up_exc (result, closest, pa, pb, p3, p2, p1);
    else if (approx_lesser (p3.z, p1.z)) // 1-2,3
      return colis_xz_element_dn_exc (result, closest, pa, pb, p3, p1, p2);
    else // 1-2-3
      return false;
...
{
  if (approx_lesser (pa.z, l.z)) //+inc
    return false;

  lin_relat le = calc_dxdz_line (t, l);
  if (approx_lesser (pa.x, le.m * pa.z + le.b)) //+inc
    return false;

  lin_relat re = calc_dxdz_line (t, r);
  if (approx_greater (pa.x, re.m * pa.z + re.b)) //+inc
    return false;
...
inline bool colis_xz_element_dn_inc (point_3d* result, point_3d* closest,
  point_3d pa, point_3d pb, point_3d b, point_3d l, point_3d r)
{
  if (approx_greater (pa.z, l.z)) //+inc
    return false;
...
inline bool colis_xz_element_up_exc (point_3d* result, point_3d* closest,
  point_3d pa, point_3d pb, point_3d t, point_3d l, point_3d r)
{
  if (approx_lesser_inc (pa.z, l.z)) //+inc
    return false;

  lin_relat le = calc_dxdz_line (t, l);
  if (approx_lesser_inc (pa.x, le.m * pa.z + le.b)) //+inc
    return false;

  lin_relat re = calc_dxdz_line (t, r);
  if (approx_greater_inc (pa.x, re.m * pa.z + re.b)) //+inc
    return false;
...
inline bool colis_xz_element_dn_exc (point_3d* result, point_3d* closest,
  point_3d pa, point_3d pb, point_3d b, point_3d l, point_3d r)
{
  if (approx_greater_inc (pa.z, l.z)) //+inc
    return false;
  ...
  point_3d tent_top, point_3d tent_bot)
{
  ...
  if (path_int_plane_xz_neg (p1.y, slide, &pa, curr_bot, tent_bot)) {
    ...
    if (colis_xz_plane_exc (result, &closer, radius, pa, pb, p2b, p2a, p1b))
      colis = true;
    if (colis_xz_plane_exc (result, &closer, radius, pa, pb, p2a, p1a, p1b))
      colis = true;
  ...
  point_3d tent_top, point_3d tent_bot)
{
  ...
  if (path_int_plane_xz_neg (p1.y, slide, &pa, curr_bot, tent_bot)) {
    ...
    if (colis_xz_plane_exc (result, &closer, radius, pa, pb, p2a, p2b, p1b))
      colis = true;
    if (colis_xz_plane_exc (result, &closer, radius, pa, pb, p2a, p1b, p1a))
      colis = true;
  ...
  point_3d tent_top, point_3d tent_bot)
{
  ...
  if (path_int_plane_xz_pos (p1.y, slide, &pa, curr_top, tent_top)) {
    ...
    if (colis_xz_plane_exc (result, &closer, radius, pa, pb, p1b, p2a, p2b))
      colis = true;
    if (colis_xz_plane_exc (result, &closer, radius, pa, pb, p1b, p1a, p2a))
      colis = true;
  ...
  point_3d tent_top, point_3d tent_bot)
{
  ...
  if (path_int_plane_xz_pos (p1.y, slide, &ntersect, curr_top, tent_top)) {
    ...
    if (colis_xz_plane_exc (result, &closer, radius, ntersect, pb, p1b, p1a, p2b))
      colis = true;
    if (colis_xz_plane_exc (result, &closer, radius, ntersect, pb, p1a, p2a, p2b))
      colis = true;
  ...
  if (pen) {
    if (approx_greater_inc (pa.y, l.y)) { // - inc
      ...
      if (approx_greater (pb.y, l.y))
        ...
        if (path_int_xy_horz (pa, pb, pen, plane, offset, l, r, slide, res_plane, result))
          return true;
    }

    lin_relat le = calc_dxdy_line (t, l);
    if (approx_lesser_inc (pa.x, le.m * pa.y + le.b)) { //-inc
      a_in = false;
    ...
    if (approx_greater_inc (pa.x, re.m * pa.y + re.b)) { //-inc
      a_in = false;
    ...
    lin_relat le = calc_dxdy_line (t, l);
    if (approx_lesser (pa.x, le.m * pa.y + le.b)) { //-inc
      a_in = false;
      if (approx_lesser (pb.x, le.m * pb.y + le.b))
        return false;
      else
    ...
    lin_relat re = calc_dxdy_line (t, r);
    if (approx_greater (pa.x, re.m * pa.y + re.b)) { //-inc
      a_in = false;
      if (approx_greater (pb.x, re.m * pb.y + re.b))
        return false;
      else
  ...
  double offset, point_3d pa, point_3d pb, bool pen, point_3d b, point_3d l, point_3d r)
{
  ...
  if (pen) {
    ...
    lin_relat le = calc_dxdy_line (b, l);
    if (approx_lesser (pa.x, le.m * pa.y + le.b)) {
      a_in = false;
      if (approx_lesser (pb.x, le.m * pb.y + le.b))
        return false;
      else
    ...
    lin_relat re = calc_dxdy_line (b, r);
    if (approx_greater (pa.x, re.m * pa.y + re.b)) {
      a_in = false;
      if (approx_greater (pb.x, re.m * pb.y + re.b))
        return false;
      else
  ...
  point_3d l, point_3d r, bool* slide, plane_type* res_plane, point_3d* result)
{
  ...
  if (approx_greater_inc (int_x, l.x))  // - inc
    if (approx_lesser_inc (int_x, r.x)) { // - inc
      result->y = l.y;
   ...
   point_3d tent_top, point_3d tent_bot)
{
  ...
  if (path_int_plane_xyz (group, cyl, &result_a, &result_b, &pen, curr_top, curr_bot, tent_top, tent_bot, offset)) {
    closer = result_b;
//    bprint ("pen plane fwd", group.plane.sec_m1, 16);
    for (tri_type* tri = group.first; tri != NULL; tri = tri->next)
      if (colis_xy_tri (slide, &plane, result, &closer, group, -cyl.radius, result_a, result_b, pen, tri->t3d.p1->abs, tri->t3d.p2->abs, tri->t3d.p3->abs, curr_top, curr_bot, tent_top, tent_bot)) {
        colis = true;
      }
  }
   ...
   point_3d tent_top, point_3d tent_bot)
{
  ...
  double offset = group.plane.sec_m1 * cyl.radius;
  bool pen;
//  bprint ("pen plane rev", group.plane.sec_m1, 16);
//  bprint ("offset rev ", group.plane.sec_m1, 16);
    
  if (path_int_plane_xyz (group, cyl, &result_a, &result_b, &pen, curr_top, curr_bot, tent_top, tent_bot, offset)) {
    closer = result_b;
    for (tri_type* tri = group.first; tri != NULL; tri = tri->next)
      if (colis_xy_tri (slide, &plane, result, &closer, group, cyl.radius, result_a, result_b, pen, tri->t3d.p3->abs, tri->t3d.p2->abs, tri->t3d.p1->abs, curr_top, curr_bot, tent_top, tent_bot)) {
        colis = true;
      }
  }
   ...
   point_3d tent_top, point_3d tent_bot)
{
  ...
  if (path_int_plane_xz (group, cyl, &result_a, curr_top, curr_bot, tent_top, tent_bot)) {
    ...
    for (tri_type* tri = group.first; tri != NULL; tri = tri->next)
      if (colis_xy_tri (slide, &plane, result, &closer, group, -cyl.radius, result_a, result_b, true, tri->t3d.p1->abs, tri->t3d.p2->abs, tri->t3d.p3->abs, curr_top, curr_bot, tent_top, tent_bot))
        colis = true;
  }
   ...
   point_3d tent_top, point_3d tent_bot)
{
  ...
  if (path_int_plane_xz (group, cyl, &result_a, curr_top, curr_bot, tent_top, tent_bot)) {
    ...
    result_b = offset_point_3d (result_a, 0, cyl.height, 0);
    for (tri_type* tri = group.first; tri != NULL; tri = tri->next)
      if (colis_xy_tri (slide, &plane, result, &closer, group, cyl.radius, result_a, result_b, true, tri->t3d.p3->abs, tri->t3d.p2->abs, tri->t3d.p1->abs, curr_top, curr_bot, tent_top, tent_bot))
        colis = true;
  }
   ...
   point_3d tent_top, point_3d tent_bot)
{
  ...
  if (approx_lesser (p1.y, p2.y))
    if (approx_lesser (p3.y, p1.y)) { // 3,1,2
      ...
      if (colis_xy_tri_up (slide, res_plane, result, closest, group, offset, pa, pb, pen, p3, mid, p1, curr_top, curr_bot, tent_top, tent_bot))
        colis = true;
      if (colis_xy_tri_dn (slide, res_plane, result, closest, group, offset, pa, pb, pen, p2, mid, p1, curr_top, curr_bot, tent_top, tent_bot))
        colis = true;
    }
    else if (approx_greater (p3.y, p2.y)) { // 1,2,3
      point_3d mid = int_xy_edge_and_y (p1, p2, p3);
      if (colis_xy_tri_up (slide, res_plane, result, closest, group, offset, pa, pb, pen, p1, mid, p2, curr_top, curr_bot, tent_top, tent_bot))
        colis = true;
      if (colis_xy_tri_dn (slide, res_plane, result, closest, group, offset, pa, pb, pen, p3, mid, p2, curr_top, curr_bot, tent_top, tent_bot))
        colis = true;
    }
    else if (approx_equal (p3.y, p1.y)) // 1-3,2
      return colis_xy_tri_dn (slide, res_plane, result, closest, group, offset, pa, pb, pen, p2, p3, p1, curr_top, curr_bot, tent_top, tent_bot);
    else if (approx_equal (p3.y, p2.y)) // 1,2-3
      return colis_xy_tri_up (slide, res_plane, result, closest, group, offset, pa, pb, pen, p1, p3, p2, curr_top, curr_bot, tent_top, tent_bot);
    else { // 1,3,2
      point_3d mid = int_xy_edge_and_y (p1, p3, p2);
      if (colis_xy_tri_up (slide, res_plane, result, closest, group, offset, pa, pb, pen, p1, p3, mid, curr_top, curr_bot, tent_top, tent_bot))
        colis = true;
      if (colis_xy_tri_dn (slide, res_plane, result, closest, group, offset, pa, pb, pen, p2, p3, mid, curr_top, curr_bot, tent_top, tent_bot))
        colis = true;
    }
  else if (approx_greater (p1.y, p2.y))
    if (approx_lesser (p3.y, p2.y)) { // 3,2,1
      point_3d mid = int_xy_edge_and_y (p3, p2, p1);
      if (colis_xy_tri_up (slide, res_plane, result, closest, group, offset, pa, pb, pen, p3, p2, mid, curr_top, curr_bot, tent_top, tent_bot))
        colis = true;
      if (colis_xy_tri_dn (slide, res_plane, result, closest, group, offset, pa, pb, pen, p1, p2, mid, curr_top, curr_bot, tent_top, tent_bot))
        colis = true;
    }
    else if (approx_greater (p3.y, p1.y)) { // 2,1,3
      point_3d mid = int_xy_edge_and_y (p2, p1, p3);
      if (colis_xy_tri_up (slide, res_plane, result, closest, group, offset, pa, pb, pen, p2, p1, mid, curr_top, curr_bot, tent_top, tent_bot))
        colis = true;
      if (colis_xy_tri_dn (slide, res_plane, result, closest, group, offset, pa, pb, pen, p3, p1, mid, curr_top, curr_bot, tent_top, tent_bot))
        colis = true;
    }
    else if (approx_equal (p3.y, p2.y)) // 2-3,1
      return colis_xy_tri_dn (slide, res_plane, result, closest, group, offset, pa, pb, pen, p1, p2, p3, curr_top, curr_bot, tent_top, tent_bot);
    else if (approx_equal (p3.y, p1.y)) // 2,1-3
      return colis_xy_tri_up (slide, res_plane, result, closest, group, offset, pa, pb, pen, p2, p1, p3, curr_top, curr_bot, tent_top, tent_bot);
    else { // 2,3,1
      point_3d mid = int_xy_edge_and_y (p2, p3, p1);
      if (colis_xy_tri_up (slide, res_plane, result, closest, group, offset, pa, pb, pen, p2, mid, p3, curr_top, curr_bot, tent_top, tent_bot))
        colis = true;
      if (colis_xy_tri_dn (slide, res_plane, result, closest, group, offset, pa, pb, pen, p1, mid, p3, curr_top, curr_bot, tent_top, tent_bot))
        colis = true;
    }
  else
    if (approx_lesser (p3.y, p1.y)) // 3,1-2
      return colis_xy_tri_up (slide, res_plane, result, closest, group, offset, pa, pb, pen, p3, p2, p1, curr_top, curr_bot, tent_top, tent_bot);
    else if (approx_greater (p3.y, p1.y)) // 1-2,3
      return colis_xy_tri_dn (slide, res_plane, result, closest, group, offset, pa, pb, pen, p3, p1, p2, curr_top, curr_bot, tent_top, tent_bot);
    else // 1-2-3
      return false;
   ...
   point_3d tent_top, point_3d tent_bot)
{
  ...
  plane_type plane;// = *res_plane;
  double z_offset = offset * group.plane.sec_m1;

  bprint ("rl up ", (180 / PI) * angle, 19);
  ...
  if (colis_xy_element_up (slide, &plane, result, group.plane, z_offset, pa, pb, pen, tl, bl, br)) {
    store_closer (closest, *result, pa, plane, slide, res_plane);
    colis = true;    
  }
  if (colis_xy_element_dn (slide, &plane, result, group.plane, z_offset, pa, pb, pen, br, tl, tr)) {
    store_closer (closest, *result, pa, plane, slide, res_plane);
    colis = true;
  }
  ...
  point_3d ntersect, point_3d curr, point_3d tent)
{
  ...
  if (plane.y_plane) {
    ...
    point_3d imag;
    double a = calc_fall_angle (plane);
    imag.x = tent.x;
    imag.z = tent.z;
    ...
    if (sin(a) <= mu * cos(a))
      ...
      imag.y = ntersect.y + g * (1.0 - mu / tan(a));
...
//    check_controls__make__ (cursor, view, first_point, first_group);
    check_controls__game__ (cursor, view);
  }
  else {
    check_controls__make__ (cursor, view, first_point, first_group);
  }
  ...
  bool hit;
  bool slide = false;
  res_plane.y_plane = res_plane.m1_inf = true;
...
*/
//  if ((res_plane.y_plane) && (res_plane.m1_inf))
//    bprint ("none ", 18);
//  else
//    bprint ("res m2 ", res_plane.m2, 18);
}
...
double calc_fall_angle (plane_type plane)
{
  return atan(1 / fabs(plane.m2 * cos(atan(plane.m1))));
}
